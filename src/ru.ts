...
export const ru: LocaleTable = {
  ...
  'auth.enterCodeBody': 'Мы отправили 6-значный код на {{email}}',
  'auth.codePlaceholder': '6-значный код',
  'auth.verify': 'Подтвердить',
  'auth.verifying': 'Проверка…',
  'auth.resendCode': 'Отправить код повторно',
  'auth.resendCodeIn': 'Повторно через {{seconds}} с',
  'auth.codeIncorrect': 'Код не подошёл — проверьте его или запросите новый.',
  'auth.codeResent': 'Новый код отправлен.',
  'auth.wrongEmailBack': 'Неверный адрес? Назад',
  'auth.tooManyAttempts': 'Слишком много попыток. Подождите минуту и попробуйте снова.',
  ...
  'ai.bahaiDisclaimer': 'Создано ИИ — не является авторитетным толкованием Писаний Бахаи.',
  ...
  'share.shareVia': 'Поделиться…',
  'share.revoke': 'Отозвать',
  'share.revokeConfirm': 'Отозвать эту ссылку? Все, у кого она есть, потеряют доступ.',
  'share.discoverToggle': 'Опубликовать в «Обзоре»',
  'share.discoverToggleHint': 'Любой сможет найти и сохранить эту подборку.',
  'share.stopDiscover': 'Убрать из «Обзора»',
  'share.publishedNote': 'Опубликовано в «Обзоре» — выключите переключатель, чтобы прекратить доступ.',
  'share.selectOne': 'Выберите одну подборку, чтобы создать ссылку.',
  'sharePage.eyebrow': 'Общая подборка',
  'sharePage.openInReader': 'Открыть в читалке',
  'sharePage.save': 'Сохранить в мои подборки',
  'sharePage.saving': 'Сохранение…',
  'sharePage.saved': 'Сохранено в ваши подборки',
