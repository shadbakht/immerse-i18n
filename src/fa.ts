...
export const fa: LocaleTable = {
  ...
  'auth.enterCode': 'کد خود را وارد کنید',
  'auth.enterCodeBody': 'کد ۶ رقمی را به {{email}} فرستادیم',
  'auth.codePlaceholder': 'کد ۶ رقمی',
  'auth.verify': 'تأیید',
  'auth.verifying': 'در حال تأیید…',
  'auth.resendCode': 'ارسال دوباره کد',
  'auth.resendCodeIn': 'ارسال دوباره تا {{seconds}} ثانیه',
  'auth.codeIncorrect': 'این کد کار نکرد — آن را بررسی کنید یا دوباره درخواست دهید.',
  'auth.codeResent': 'کد جدید فرستاده شد.',
  'auth.wrongEmailBack': 'ایمیل اشتباه است؟ بازگشت',
  'auth.tooManyAttempts': 'تلاش‌های بیش از حد. یک دقیقه صبر کنید و دوباره امتحان کنید.',
  ...
  'ai.bahaiDisclaimer': 'تولیدشده توسط هوش مصنوعی؛ تفسیری معتبر از آثار بهائی نیست.',
