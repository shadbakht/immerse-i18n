...
export const tr: LocaleTable = {
  ...
  'auth.enterCodeBody': '{{email}} adresine 6 haneli bir kod gönderdik',
  'auth.codePlaceholder': '6 haneli kod',
  'auth.verify': 'Doğrula',
  'auth.verifying': 'Doğrulanıyor…',
  'auth.resendCode': 'Kodu yeniden gönder',
  'auth.resendCodeIn': '{{seconds}} sn sonra yeniden gönder',
  'auth.codeIncorrect': 'Bu kod işe yaramadı — kontrol edin veya yeniden gönderin.',
  'auth.codeResent': 'Yeni kod gönderildi.',
  'auth.wrongEmailBack': 'Yanlış e-posta mı? Geri dön',
  'auth.tooManyAttempts': 'Çok fazla deneme. Bir dakika bekleyip tekrar deneyin.',
  ...
  'share.shareVia': 'Paylaş…',
  'share.revoke': 'İptal et',
  'share.revokeConfirm': 'Bu bağlantı iptal edilsin mi? Bağlantıya sahip olan herkes erişimi kaybeder.',
  'share.discoverToggle': 'Keşfet’te yayınla',
  'share.discoverToggleHint': 'Herkes bu derlemeyi bulabilir ve kaydedebilir.',
  'share.stopDiscover': 'Keşfet’ten kaldır',
  'share.publishedNote': 'Keşfet’te yayınlandı — paylaşımı durdurmak için anahtarı kapatın.',
  'share.selectOne': 'Bağlantı oluşturmak için bir derleme seçin.',
  'sharePage.eyebrow': 'Paylaşılan derleme',
  'sharePage.openInReader': 'Okuyucuda aç',
  'sharePage.save': 'Derlemelerime kaydet',
  'sharePage.saving': 'Kaydediliyor…',
  'sharePage.saved': 'Derlemelerine kaydedildi',
