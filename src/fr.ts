...
export const fr: LocaleTable = {
  ...
  'auth.chooseUsernameTitle': "Choisissez un nom d’utilisateur",
  'auth.chooseUsernameBlurb': "C’est ainsi que les autres vous verront dans Découvrir.",
  'auth.alreadyHaveAccount': 'Vous avez déjà un compte Immerse ?',
  'auth.linkAccountBlurb': "Indiquez l’e-mail de votre compte existant — nous vous envoyons un code pour confirmer qu’il vous appartient, puis nous y relions cette connexion.",
  ...
  'auth.enterCodeBody': 'Nous avons envoyé un code à 6 chiffres à {{email}}',
  ...
  'auth.codeIncorrect': "Ce code n'a pas fonctionné — vérifiez-le ou demandez-en un autre.",
  'auth.codeResent': 'Nouveau code envoyé.',
  'auth.wrongEmailBack': 'Mauvaise adresse e-mail ? Retour',
  'auth.tooManyAttempts': 'Trop de tentatives. Attendez une minute et réessayez.',
  ...
  'ai.bahaiDisclaimer': 'Généré par IA — ceci n’est pas une interprétation faisant autorité des Écrits bahá’ís.',
  ...
  'listen.useSystemVoice': 'Utiliser la voix du système',
  ...
  'sharePage.xrefEyebrow': 'Renvois partagés',
  'sharePage.saveXrefs': 'Enregistrer dans mes renvois',
  'sharePage.savedXrefs': 'Enregistrés dans vos renvois',
  'sharePage.savedXrefsPartial': '{{saved}} sur {{total}} enregistrés — {{skipped}} nécessitent du contenu que vous n’avez pas',
  'sharePage.xrefsGone': 'Ces renvois ne sont plus disponibles',
