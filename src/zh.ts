...
export const zh: LocaleTable = {
  ...
  'auth.enterCodeBody': '我们已向 {{email}} 发送了 6 位验证码',
  'auth.codePlaceholder': '6 位验证码',
  'auth.verify': '验证',
  'auth.verifying': '正在验证…',
  'auth.resendCode': '重新发送验证码',
  'auth.resendCodeIn': '{{seconds}} 秒后可重新发送',
  'auth.codeIncorrect': '验证码无效，请检查后重试或重新获取。',
  'auth.codeResent': '已发送新验证码。',
  'auth.wrongEmailBack': '邮箱有误？返回',
  'auth.tooManyAttempts': '尝试次数过多，请稍候一分钟后再试。',
  ...
  'voice.previewPlay': '播放预览',
  'voice.previewPause': '停止预览',
  ...
  'appearance.textSizeSmall': '特小',
  'appearance.textSizeMedium': '小',
  'appearance.textSizeLarge': '中',
  'appearance.textSizeXL': '大',
  'appearance.textSizeXXL': '加大',
  'appearance.textSizeXXXL': '特大',
